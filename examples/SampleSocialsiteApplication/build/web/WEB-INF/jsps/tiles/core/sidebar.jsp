...
<div id="logo">
    <h1><a href='<s:url value="/" />'><s:property value="getProp('samplesocialsiteapplication.site.name')"/></a></h1>
    <h2><s:property value="getProp('samplesocialsiteapplication.site.description')"/></h2>
...
<div class="box">
    ...
    <ul class="bottom">
        <s:if test="%{viewerId != null}">
            ...
            <li>Logged in as [<s:property value="viewerId" />]</li>
