...
"gadgets.jsUriTemplate" : "http://%host%${context.contextpath}/gadgets/js/%js%",

// Callback URL.  Scheme relative URL for easy switch between https/http.
"gadgets.oauthGadgetCallbackTemplate" : "//%host%${context.contextpath}/gadgets/oauthcallback",
...
"gadgets.osDataUri" : "http://%host%${context.contextpath}/social/rpc",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://%host%${context.contextpath}/gadgets/proxy?refresh=%refresh%&url=%url%%rewriteMime%",
    "jsonProxyUrl" : "http://%host%${context.contextpath}/gadgets/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://%host%${context.contextpath}/gadgets/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "http://%host%${context.contextpath}/gadgets/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    }
  },
  "rpc" : {
    ...
    "parentRelayUrl" : "%${context.contextpath}/gadgets/files/container/rpc_relay.html",
  ...
  "opensocial-0.9" : {
    ...
    "path" : "http://%host%${context.contextpath}/social/rpc",
    // Path to issue invalidate calls
    "invalidatePath" : "http://%host%${context.contextpath}/gadgets/api/rpc",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
  ...
  "osapi.services" : {
    ...
    // E.g. 
  "gadgets.rpc" : ["activities.requestCreate", "messages.requestSend", "requestShareApp", "requestPermission"]
  //  "gadgets.rpc" : ["container.listMethods"]
  },
  //"osapi" : {
    // The endpoints to query for available JSONRPC/REST services
     "endPoints" : [ "http://%host%${context.contextpath}/social/rpc", "http://http://%host%${context.contextpath}/gadgets/api/rpc" ]                  
  },
  "osml": {
