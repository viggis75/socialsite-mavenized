...
public class ActivityServiceImpl implements ActivityService {
    ...
    private RestfulCollection<Activity> getActivitiesInternal(Set<UserId> userIds,
        ...
        try {
            ...
            throw new SocialSpiException(
                HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Problem getting activities", e);
        }
    ...
    private Void createActivityInternal(UserId userId, GroupId groupId, String appId,
        ...
        try {
            ...
            throw new SocialSpiException(
                HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "ERROR creating activity", e);
        }
    ...
    private Activity getActivityInternal(UserId userId, GroupId groupId, String appId,
        ...
        try {
            ...
            if (activity == null) {
                throw new SocialSpiException(
                    HttpServletResponse.SC_BAD_REQUEST, "No such activity: " + activityId);
            }
            ...
            throw new SocialSpiException(
                HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Problem deleting activities", e);
        }
     ...
     * @param groupId    The group.
     * @param appId      The app id.
     * @param activityIds The id of the activity to delete.
     * @param token      A valid SecurityToken.
     * @return a response item containing any errors
     */
    private Void deleteActivityInternal(UserId userId, GroupId groupId, 
        ...
        try {
            ...
            for (Iterator<String> it = activityIds.iterator(); it.hasNext();) {
                ...
                if (acontent == null) {
                    throw new SocialSpiException(
                        HttpServletResponse.SC_BAD_REQUEST, "No such activity: " + aid);
                }
